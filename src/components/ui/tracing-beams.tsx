            ...
            <div className="absolute -left-4 top-3 md:-left-20">
                ...
                >
                    <motion.div
                        ...
                        animate={{
                            backgroundColor: scrollYProgress.get() > 0 ? 'white' : 'var(--pink-300)',
                            borderColor: scrollYProgress.get() > 0 ? 'white' : 'var(--indigo-800)'
                        }}
                ...
                >
                    ...
                    <defs>
                        <motion.linearGradient
                            ...
                            y2={y2}
                        >
                            <stop stopColor="#3730A3" stopOpacity="0"></stop> 
                            <stop stopColor="#3730A3"></stop> 
                            <stop offset="0.325" stopColor="#F9A8D4"></stop> 
                            <stop offset="1" stopColor="#F9A8D4" stopOpacity="0"></stop>
                        </motion.linearGradient>
                    </defs>
                </svg>
            </div>
