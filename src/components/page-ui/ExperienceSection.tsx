...
const experience = [
    ...
    },
    {
      ...
      description: (
        <ul className="list-disc">
          <li>
            Development internship, designing and creating Fortnite maps using Unreal Editor for Fortnite and Verse.
          </li>
          <li>
    ...
    },
    {
      ...
      description: (
        <ul className="list-disc">
          <li>
            <strong>Patriota:</strong> Full design & development of frontend (React + Next.js + TailwindCSS), backend (Node.js + Express) and MongoDB database for digital catalog, currently in pre-production.
          </li>
          <li>
            <strong>Lunardi:</strong> Design & Development of a landing page with React + Next.js + TailwindCSS, currently in pre-production.
          </li>
          <li>
            <strong>Fotearte:</strong> Design & Development of a landing page in React, already in production.
          </li>
        </ul>
      ),
